let T,A,N,h={inepMetadata:!1,enrichment:!1},$=Promise.resolve();function b(e="q"){let t="";return h.inepMetadata&&(t+=`
LEFT JOIN question_inep_metadata AS im ON im.question_id = ${e}.id`),h.enrichment&&(t+=`
LEFT JOIN question_enrichment AS qe ON qe.question_id = ${e}.id`),t}function y(e="q"){return h.inepMetadata?`COALESCE(
    CASE im.area
    ...
    END,
    ${e}.discipline
  )`:`${e}.discipline`}function M(e="q"){return h.enrichment?`COALESCE(qe.display_title, ${e}.title)`:`${e}.title`}function C(){return h.inepMetadata?`im.item_code AS inep_item_code,
          ...
          im.match_score AS inep_match_score`:`NULL AS inep_item_code,
            ...
            NULL AS inep_tri_b,
            NULL AS inep_tri_c,
            NULL AS inep_match_score`}function x(){return h.enrichment?`qe.subject AS enrichment_subject,
          qe.topic AS enrichment_topic,
          qe.source AS enrichment_source`:`NULL AS enrichment_subject,
            NULL AS enrichment_topic,
            NULL AS enrichment_source`}function O(e){return e!==null&&typeof e=="object"&&!Array.isArray(e)}function c(e,t,n,i){const a=new Error(t);return a.name=e,n&&(a.code=n),i!==void 0&&(a.details=i),a}function F(e){const t=e instanceof Error?e:new Error(String(e)),n={name:typeof t.name=="string"?t.name:"Error",message:typeof t.message=="string"?t.message:String(t)};if((typeof t.code=="string"||typeof t.code=="number")&&(n.code=t.code),typeof t.resultCode=="number"&&(n.resultCode=t.resultCode),t.details!==void 0)try{JSON.stringify(t.details),n.details=t.details}catch{n.details=String(t.details)}return typeof t.stack=="string"&&(n.stack=t.stack),n}function H(e,t){self.postMessage({id:e??null,type:"response",ok:!0,result:t})}function U(e,t){self.postMessage({id:e??null,type:"response",ok:!1,error:F(t)})}async function B(){return T||(T=import("./index-Drrgq86s.js").then(async e=>{const t=e.default??e.sqlite3InitModule;if(typeof t!="function")throw c("SQLiteLoadError","O módulo @sqlite.org/sqlite-wasm não exportou sqlite3InitModule.","SQLITE_MODULE_INVALID");return t()})),T}function v(){if(!N)throw c("DatabaseNotInitializedError","O banco SQLite ainda não foi inicializado.","DB_NOT_INITIALIZED");return N}function E(e,t,n){const i=[],a={sql:t,rowMode:"object",resultRows:i};return n!==void 0&&(a.bind=n),e.exec(a),i}function l(e){return typeof e=="bigint"?Number(e):e}function k(e){return e instanceof ArrayBuffer||typeof SharedArrayBuffer<"u"&&e instanceof SharedArrayBuffer}function Q(e){return k(e)?new Uint8Array(e):ArrayBuffer.isView(e)?new Uint8Array(e.buffer,e.byteOffset,e.byteLength):null}function G(e){const t=e?.payload,n=[t,t?.buffer,t?.arrayBuffer,e?.buffer,e?.arrayBuffer];for(const i of n){const a=Q(i);if(a)return a}return null}function w(){const e=N;N=void 0,h={inepMetadata:!1,enrichment:!1},e&&e.close()}async function W(e){const t=G(e);if(!t||t.byteLength===0)throw c("InvalidArgumentError","init exige um ArrayBuffer não vazio contendo um banco SQLite.","INVALID_DATABASE_BUFFER");A=await B(),w();const n=new A.oo1.DB;let i,a=!1;try{i=A.wasm.allocFromTypedArray(t);const s=A.capi.sqlite3_deserialize(n.pointer,"main",i,t.byteLength,t.byteLength,0);n.checkRc(s),a=!0,n.onclose={after:()=>{i&&(A.wasm.dealloc(i),i=void 0)}};const m=E(n,`SELECT name
         FROM sqlite_schema
        WHERE type = 'table'
